	...
	<div class="wx-recharge">
		...
		<section class="vue-recharge" v-if="recharge">
			<div class="rechar_teltei" v-if='pay_list.rechargetext'>
				...
				<!-- <p>
                  2. 单笔提现金额最低50元最高50000元
              </p>
              <p>
                  3. 晚上22:00~次日1：00为系统结算时间，不可提现
              </p> -->
			</div>
			...
			<div class="body-header">
				...
				<img :src="pay_list.rechargeicon" alt="暂无">
				{{pay_list.rechargename}}
			</div>
			...
			<div class="numderActual">实际到账：<span style="color: #e6474b;">{{(numder*(1+menybei))|numberFormat}}元</span></div>
		...
		<section class="vue-recharge" v-else>
			...
			<div class="confirm-recharge">
				<div class="hader-icon">
					<img src="../../assets/recharge/queren.png" />
				</div>
				...
				<div class="text">
					<p>1.如果未打开{{pay_list.rechargename}}或是未完成付款,请重新点击"确认支付"</p>
					<p>2.如果已完成,请点击“已完成付款”</p>
				</div>
				<!-- 点击确认支付微信form -->
				<form :action="pay_list.rechargeurl" method="post">
...
.aui-title {
	...
	.body-header {
		...
		padding-left: 0.7rem;
		/* background-image: url(../../assets/recharge/weixinzhifu-copy.png);
