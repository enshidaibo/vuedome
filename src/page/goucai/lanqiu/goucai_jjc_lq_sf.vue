<template>
	...
	<div>
	   ...
	   <div  class="shengf_fm main">
            <template v-for="(item, cindex) in RQSPFlist">
        <div class="countime" :id="'jjc_sfTime' + cindex" @click="showList(cindex)" data-state="open">
      ...
      <div class="jjc_sc_cont jjc_rxjc_cont jjc_exy_cont jjc_sf_cont" v-show="showListarr[cindex]">
