...
<style scoped>
	...
	.information_system_list .main_list .li .li-icon8,.information_system_list .main_list .li .li-icon12,.information_system_list .main_list .li .li-icon26,.information_system_list .main_list .li .li-icon27 {
		background-image: url(../../../../static/information/realname_friend.png);
	}
	.information_system_list .main_list .li .li-icon9,.information_system_list .main_list .li .li-icon15,.information_system_list .main_list .li .li-icon25,.information_system_list .main_list .li .li-icon28,.information_system_list .main_list .li .li-icon29 {
		background-image: url(../../../../static/information/recharge_friend.png);
	}
	.information_system_list .main_list .li .li-icon17,.information_system_list .main_list .li .li-icon18,.information_system_list .main_list .li .li-icon21,.information_system_list .main_list .li .li-icon12 {
		background-image: url(../../../../static/information/buddy_betting.png);
	}
