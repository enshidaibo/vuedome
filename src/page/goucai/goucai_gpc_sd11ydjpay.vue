<template>
    ...
    <div class="aui-title">山东11运夺金</div>
    <div class="share_btn aui-pull-right" @click="fenx()">
		...
		<header class="aui-bar aui-bar-nav">
			...
			<div>
				<div class="aui-title" tapmode>山东11运夺金 
		...
		<module-pay :payPopupP='payPopup' :payMoneyP='payMoney' :coinsMoneyP='coinsMoney' :cashMoneyP='cashMoney'
		 :opnenWeixinP='opnenWeixin' :opnenBankopenP='opnenBankopen' :hasHongbaoP='false' :typeName='"山东11运夺金"' @payPopupC="payPopupC"
