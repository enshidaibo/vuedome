...
<style scoped>
	...
	.information_system_list .main_list .li .li-icon7 {
		background-image: url(../../../../static/information/registration_user.png);
	}
	.information_system_list .main_list .li .li-icon11 {
		background-image: url(../../../../static/information/realname.png);
	}
	.information_system_list .main_list .li .li-icon22,.information_system_list .main_list .li .li-icon23 {
		background-image: url(../../../../static/information/purchase_user.png);
	}
	.information_system_list .main_list .li .li-icon13,.information_system_list .main_list .li .li-icon14 {
		background-image: url(../../../../static/information/recharge.png);
	}
	.information_system_list .main_list .li .li-icon19,.information_system_list .main_list .li .li-icon20 {
		background-image: url(../../../../static/information/drying_list.png);
	}
