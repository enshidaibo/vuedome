<template>
	<div>
		...
		<header class="aui-bar aui-bar-nav">
			...
			<div>
				<div class="aui-title" tapmode>安徽快三
		...
		<module-pay :payPopupP='payPopup' :payMoneyP='payMoney' :coinsMoneyP='coinsMoney' :cashMoneyP='cashMoney'
		 :opnenWeixinP='opnenWeixin' :opnenBankopenP='opnenBankopen' :hasHongbaoP='false'  :typeName='"安徽快三"' @payPopupC="payPopupC" @RouteLeaveC='RouteLeaveC'
