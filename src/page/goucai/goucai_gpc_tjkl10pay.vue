...
<!-- 		<header class="aui-bar aui-bar-nav">
			...
			<div class="aui-title">天津快乐10分</div>
		    ...
		    <div>
		      <div class="aui-title"  tapmode>天津快乐10分 
...
<!-- 				<footer>
		...
		<module-pay :payPopupP='payPopup' :payMoneyP='payMoney' :coinsMoneyP='coinsMoney' :cashMoneyP='cashMoney'
		 :opnenWeixinP='opnenWeixin' :opnenBankopenP='opnenBankopen' :hasHongbaoP='false' :typeName='"天津快乐10分"' @payPopupC="payPopupC" @RouteLeaveC='RouteLeaveC'
