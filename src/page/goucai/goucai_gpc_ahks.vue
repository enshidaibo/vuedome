...
<header class="aui-bar aui-bar-nav">
    ...
    <div>
        <div style="width:60%;left:4rem" class="aui-title" @click="ChoiceType()"><span>安徽快三</span> <span id="pagetitle">{{playTypeName}}</span> <img src="../../assets/goucai/jjc/xiajiantou.png" /></div>
    </div>
