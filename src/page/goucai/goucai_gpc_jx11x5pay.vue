...
<!-- <header class="aui-bar aui-bar-nav">
    ...
    <div class="aui-title">江西11选5</div>
    <div class="share_btn aui-pull-right" @click="fenx()">
        <span class="aui-iconfont aui-icon-share" ></span>
         ...
         <header class="aui-bar aui-bar-nav">
             ...
             <div>
               <div class="aui-title"  tapmode>江西11选5
...
<module-pay :payPopupP='payPopup' :payMoneyP='payMoney' :coinsMoneyP='coinsMoney' :cashMoneyP='cashMoney'
		 :opnenWeixinP='opnenWeixin' :opnenBankopenP='opnenBankopen' :hasHongbaoP='false' :typeName='"江西11选5"' @payPopupC="payPopupC" @RouteLeaveC='RouteLeaveC'
...
beforeRouteLeave (to, from , next) {
    if (this.RouteLeave||to.name=='goucai_hemai'||to.name=='agreement'||this.paydj.data.length == 0) {
        next()
    } else {
        MessageBox({
            title:'',
...
methods:{
    ...
    openSuccessWin: function() {
		...
		var datas =  this.Qs.stringify({
		    "path":"number/keno/jxel11to5",data
		},{allowDots: true});
    ...
    setData: function() {
        ...
        if (this.paydj.danlist == "normalList") {
            for (var i = 0; i < this.paydj.data.length; i++) {
                var strdata = [];
                if (this.paydj.navname == "任选二") {playType = 'randomTwo';playMethod = 'normal';var betStr = this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "任选三") {playType = 'randomThree';playMethod = 'normal';var betStr = this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "任选四") {playType = 'randomFour';playMethod = 'normal';var betStr = this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "任选五") {playType = 'randomFive';playMethod = 'normal';var betStr = this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "任选六") {playType = 'randomSix';playMethod = 'normal';var betStr = this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "任选七") {playType = 'randomSeven';playMethod = 'normal';var betStr = this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "任选八") {playType = 'randomEight';playMethod = 'normal';var betStr = this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "前二组选") {playType = 'foreTwo';playMethod = 'group';var betStr = this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "前二直选") {playType = 'foreTwo';playMethod = 'direct';var betStr = this.paydj.data[i].wanarr.join(",")+ "|" + this.paydj.data[i].qianarr.join(",");} 
                else if (this.paydj.navname == "前三组选") {playType = 'foreThree';playMethod = 'group';var betStr = this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "前三直选") {playType = 'foreThree';playMethod = 'direct';var betStr = this.paydj.data[i].wanarr.join(",")+ "|" + this.paydj.data[i].qianarr.join(",") + "|" + this.paydj.data[i].baiarr.join(",");} 
                else if (this.paydj.navname == "前一") {playType = 'foreOne';playMethod = 'direct';var betStr = this.paydj.data[i].baiarr.join(",");}
            ...
            for (var i = 0; i < this.paydj.data.length; i++) {
                var strdata = [];
                if (this.paydj.navname == "任选二") {playType = 'randomTwo';playMethod = 'duplex';var danten = this.paydj.data[i].wanarr.join(",");var betStr = this.paydj.data[i].qianarr.join(",");} 
                else if (this.paydj.navname == "任选三") {playType = 'randomThree';playMethod = 'duplex';var danten = this.paydj.data[i].wanarr.join(",");var betStr = this.paydj.data[i].qianarr.join(",");} 
                else if (this.paydj.navname == "任选四") {playType = 'randomFour';playMethod = 'duplex';var danten = this.paydj.data[i].wanarr.join(",");var betStr = this.paydj.data[i].qianarr.join(",");} 
                else if (this.paydj.navname == "任选五") {playType = 'randomFive';playMethod = 'duplex';var danten = this.paydj.data[i].wanarr.join(",");var betStr = this.paydj.data[i].qianarr.join(",");} 
                else if (this.paydj.navname == "任选六") {playType = 'randomSix';playMethod = 'duplex';var danten = this.paydj.data[i].wanarr.join(",");var betStr = this.paydj.data[i].qianarr.join(",");}
                else if (this.paydj.navname == "任选七") {playType = 'randomSeven';playMethod = 'duplex';var danten = this.paydj.data[i].wanarr.join(",");var betStr = this.paydj.data[i].qianarr.join(",");} 
                else if (this.paydj.navname == "任选八") {playType = 'randomEight';playMethod = 'duplex';var danten = this.paydj.data[i].wanarr.join(",");var betStr = this.paydj.data[i].qianarr.join(",");} 
                else if (this.paydj.navname == "前二组选") {playType = 'foreTwo';playMethod = 'groupDuplex';var danten = this.paydj.data[i].wanarr.join(",");var betStr = this.paydj.data[i].qianarr.join(",");}  
                else if (this.paydj.navname == "前三组选") {playType = 'foreThree';playMethod = 'groupDuplex';var danten = this.paydj.data[i].wanarr.join(",");var betStr = this.paydj.data[i].qianarr.join(",");}
